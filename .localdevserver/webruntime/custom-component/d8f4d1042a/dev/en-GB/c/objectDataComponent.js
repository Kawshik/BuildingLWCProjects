Webruntime.define('lwc/objectDataComponent', ['lwc', 'lightning/configProvider'], function (lwc, configProvider) { 'use strict';
    ...
    **/
    ...
    tmpl$3.stylesheetTokens = {
      hostAttribute: "lwc-objectDataComponent_objectDataComponent-host",
      shadowAttribute: "lwc-objectDataComponent_objectDataComponent"
    };

    class ObjectDataComponent extends lwc.LightningElement {
      constructor(...args) {
        super(...args);
        this.objectName = objectName + " Details";
      }

    }

    lwc.registerDecorators(ObjectDataComponent, {
      publicProps: {
        objectName: {
          config: 0
        }
    ...
    var objectDataComponent = lwc.registerComponent(ObjectDataComponent, {
      tmpl: _tmpl$4
    });
